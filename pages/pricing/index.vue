  ...
  <div class="max-w-screen-xl mx-auto">
    ...
    <div class="grid md:grid-cols-3 gap-10 mx-auto max-w-screen-lg mt-12">
      <div>
        ...
        >
          <div class="text-center">
            <h4 class="text-lg font-medium text-gray-400">Personal</h4>
            <p class="mt-3 text-4xl font-bold text-black md:text-4xl">Free</p>
          </div>
      ...
      <div>
        ...
        >
          <div class="text-center">
            <h4 class="text-lg font-medium text-gray-400">Startup</h4>
            <p class="mt-3 text-4xl font-bold text-black md:text-4xl">$19</p>
          </div>
          <ul class="grid mt-8 text-left gap-y-4">
            <li class="flex items-start gap-3 text-gray-800">
              <svg
          ...
          <div class="flex mt-8">
            <a
              aria-current="page"
              href="/pricing#"
              class="router-link-active router-link-exact-active rounded text-center transition focus-visible:ring-2 ring-offset-2 ring-gray-200 w-full px-5 py-2.5 bg-black text-white hover:bg-gray-800 border-2 border-transparent"
              >Get Started</a
            >
          </div>
        </div>
      ...
      <div>
        ...
        >
          <div class="text-center">
            <h4 class="text-lg font-medium text-gray-400">Enterprise</h4>
            <p class="mt-3 text-4xl font-bold text-black md:text-4xl">Custom</p>
          </div>
          <ul class="grid mt-8 text-left gap-y-4">
            <li class="flex items-start gap-3 text-gray-800">
              <svg
